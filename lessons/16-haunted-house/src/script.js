...
// Set texture to 1/8 size of space
floorColorTexture.repeat.set(8, 8)
floorARMTexture.repeat.set(8, 8)
floorNormalTexture.repeat.set(8, 8)
floorDisplacementTexture.repeat.set(8, 8)

// Set so texture repeats 8 times in the space
...
// Walls
const wallColorTexture = textureLoader.load('./walls/castle_brick_broken_06_1k/castle_brick_broken_06_diff_1k.jpg')
const wallARMTexture = textureLoader.load('./walls/castle_brick_broken_06_1k/castle_brick_broken_06_arm_1k.jpg')
const wallNormalTexture = textureLoader.load('./walls/castle_brick_broken_06_1k/castle_brick_broken_06_nor_gl_1k.jpg')
...
// Set scaling - need to repeat on x-axis only
...
// House group - add everything to this, NOT the scene
...
const bushMaterial = new THREE.MeshStandardMaterial({
    color: '#ccffcc', // Apply a color shift
...
bush1.rotation.x = -0.75 // lol - hide the weird coloring from the texture

const bush2 = new THREE.Mesh(bushGeometry, bushMaterial)
bush2.scale.setScalar(0.25)
bush2.position.set(1.4, 0.1, 2.1)
bush2.rotation.x = -0.75 // lol - hide the weird coloring from the texture

const bush3 = new THREE.Mesh(bushGeometry, bushMaterial)
bush3.scale.setScalar(0.4)
bush3.position.set(-0.8, 0.1, 2.2)
bush3.rotation.x = -0.75 // lol - hide the weird coloring from the texture

const bush4 = new THREE.Mesh(bushGeometry, bushMaterial)
bush4.scale.setScalar(0.15)
bush4.position.set(-1, 0.05, 2.6)
bush4.rotation.x = -0.75 // lol - hide the weird coloring from the texture
...
for (let i = 0; i < 30; i++) {
    ...
    grave.position.x = x
    grave.position.y += Math.random() * (graveHeight / 2)
    grave.position.z = z
...
doorLight.position.set(0, 2.2, 2.4) // dont know how we got these values - just copied them from the vid
house.add(doorLight)
